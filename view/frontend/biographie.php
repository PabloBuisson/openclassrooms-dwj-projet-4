...
$ogUrl = 'http://jean-forteroche.pablobuisson.fr/?action=biographie';
/* No more 65 words */
...
<article id="biographie-article">
    ...
    <div class="container-fluid bg-white pt-5 pb-5">
        <div class="row">
            <div class="pt-4 pt-md-5 col-10 offset-1 col-md-6 offset-md-5 text-justify article-content">
                Il est de notoriété publique que Jean Rochefort n'aime guère parler de lui, qui plus est à la troisième personne du singulier.<br />
                ...
                C'est pour cette raison que je m'adresserai à vous comme je m'adresserai à un vieil ami. On a plus grand chose à cacher à un vieil ami, si ce n'est cette part de mystère qui vous rend irristiblement intéressant. Car celui qui aime parler de lui suscitera très vite le désintérêt, et celui qui ne dit rien, l'ennui. Distribuer avec minutie les parcelles de son histoire, c'est bien là tout l'art de l'écrivain.<br />
